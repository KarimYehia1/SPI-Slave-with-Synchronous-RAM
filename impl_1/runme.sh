...
HD_PWD='D:/Digital_Design_Diploma/SPI_Linting/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_wrapper.tcl -notrace
